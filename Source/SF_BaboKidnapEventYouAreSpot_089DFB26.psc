...
Scriptname SF_BaboKidnapEventYouAreSpot_089DFB26 Extends Scene Hidden

;BEGIN FRAGMENT Fragment_2
Function Fragment_2()
;BEGIN CODE
actor akactor = (Kidnapper02.getreference() as actor)
...
if BaboKidnapScenarioe.getvalue() < 20
	if BaboKidnapEscapeAttempts.getvalue() <= 9
		if akactor.getfactionrank(sla_arousal) >= 80
...
Function Fragment_3()
;BEGIN CODE
(BaboSexController as BaboSexControllerManager).EventPairMotion(Kidnapper02.getreference() as actor, 0, 0, 0, 1, false)
;END CODE
EndFunction
;END FRAGMENT
...
Function Fragment_1()
;BEGIN CODE
;(Getowningquest() as BaboKidnapEvenScript).YouGotSpotted(2)
(BaboSexController as BaboSexControllerManager).EventPairMotion(Kidnapper02.getreference() as actor, 0, 0, 0, 6, false)
;END CODE
EndFunction
;END FRAGMENT
