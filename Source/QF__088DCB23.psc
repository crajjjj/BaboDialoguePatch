...
Scriptname QF__088DCB23 Extends Quest Hidden
...
;BEGIN CODE
(BaboSexController as BaboSexControllerManager).SexCustomTag(Alias_PlayerRef, Alias_CreatureRef, None, None, None, "", "", true, "CLEvent02ForestSnow", "ChangeLocationEvent02ForestSnow", true)
...
;BEGIN CODE
;Copulation Start
(BaboSexController as BaboSexControllerManager).SexCustomTag(Alias_PlayerRef, Alias_CreatureRef, None, None, None, "Vaginal", "", true, "CLEvent02ForestSnow", "ChangeLocationEvent02ForestSnow", true)
(BaboSexController as BaboSexControllerManager).AddSexCount(1)
;END CODE
EndFunction
;END FRAGMENT
...
Debug.notification("BaboDialogue: Change Location Event 02 ForestSnow fired")
endif
