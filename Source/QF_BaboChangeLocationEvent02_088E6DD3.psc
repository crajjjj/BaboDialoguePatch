...
Scriptname QF_BaboChangeLocationEvent02_088E6DD3 Extends Quest Hidden
...
;BEGIN CODE
;Copulation Start
(BaboSexController as BaboSexControllerManager).SexCustomTag(Alias_PlayerRef, Alias_CreatureRef, None, None, None, "", "", true, "CLEvent02Coast", "ChangeLocationEvent02Coast", true)
