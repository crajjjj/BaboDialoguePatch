...
Scriptname QF_BaboChangeLocationEvent02_088E1C67 Extends Quest Hidden
...
;BEGIN CODE
(BaboSexController as BaboSexControllerManager).SexCustomTag(Alias_PlayerRef, Alias_CreatureRef, None, None, None, "Vaginal", "", true, "CLEvent02MountainSnow", "ChangeLocationEvent02MountainSnow", true)
...
Debug.notification("BaboDialogue: Change Location Event 02 MountainSnow fired")
endif
...
;BEGIN CODE
;Copulation Start
(BaboSexController as BaboSexControllerManager).SexCustomTag(Alias_PlayerRef, Alias_CreatureRef, None, None, None, "", "", true, "CLEvent02MountainSnow", "ChangeLocationEvent02MountainSnow", true)
(BaboSexController as BaboSexControllerManager).AddSexCount(1)
;END CODE
EndFunction
;END FRAGMENT
