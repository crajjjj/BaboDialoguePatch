...
Scriptname QF_BaboChangeLocationEvent02_088DCB24 Extends Quest Hidden
...
;BEGIN CODE
(BaboSexController as BaboSexControllerManager).SexCustomTag(Alias_PlayerRef, Alias_CreatureRef, None, None, None, "Vaginal", "", true, "CLEvent02Mountain", "ChangeLocationEvent02Mountain", true)
...
Debug.notification("BaboDialogue: Change Location Event 02 Mountain fired")
endif
...
(BaboSexController as BaboSexControllerManager).SexCustomTag(Alias_PlayerRef, Alias_CreatureRef, None, None, None, "", "", true, "CLEvent02Mountain", "ChangeLocationEvent02Mountain", true)
(BaboSexController as BaboSexControllerManager).AddSexCount(1)
;END CODE
EndFunction
;END FRAGMENT
