...
Scriptname QF__088DCB19 Extends Quest Hidden
...
;BEGIN CODE
(BaboSexController as BaboSexControllerManager).SexCustomTag(Alias_PlayerRef, Alias_CreatureRef, None, None, None, "", "", true, "CLEvent02Forest", "ChangeLocationEvent02Forest", true)
...
(BaboSexController as BaboSexControllerManager).SexCustomTag(Alias_PlayerRef, Alias_CreatureRef, None, None, None, "Vaginal", "", true, "CLEvent02Forest", "ChangeLocationEvent02Forest", true)
(BaboSexController as BaboSexControllerManager).AddSexCount(1)
;END CODE
EndFunction
;END FRAGMENT
...
Debug.notification("BaboDialogue: Change Location Event 02 Forest fired")
endif
